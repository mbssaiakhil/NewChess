/*
 * Stub for class sapphire.policy.migration.explicitmigration.ExplicitMigrationPolicy.ServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitMigrationPolicy$ServerPolicy_Stub extends sapphire.policy.migration.explicitmigration.ExplicitMigrationPolicy.ServerPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public java.lang.Object onRPC(java.lang.String $param_String_1, java.util.ArrayList $param_ArrayList_2)
        ...
        String $__method = "public java.lang.Object sapphire.policy.migration.explicitmigration.ExplicitMigrationPolicy$ServerPolicy.onRPC(java.lang.String,java.util.ArrayList<java.lang.Object>) throws java.lang.Exception";
    ...
    public void migrateObject()
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.policy.migration.explicitmigration.ExplicitMigrationPolicy$ServerPolicy.migrateObject() throws java.lang.Exception";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    // Implementation of getOtherKernelServers(ArrayList, InetSocketAddress)
    public java.util.ArrayList getOtherKernelServers(java.util.ArrayList $param_ArrayList_1, java.net.InetSocketAddress $param_InetSocketAddress_2) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.util.ArrayList<java.net.InetSocketAddress> sapphire.policy.migration.MigrationPolicyBase$ServerPolicy.getOtherKernelServers(java.util.ArrayList<java.net.InetSocketAddress>,java.net.InetSocketAddress)";
        $__params.add($param_ArrayList_1);
        $__params.add($param_InetSocketAddress_2);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
